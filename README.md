...
| `HttpClient` | `HttpClient?` | Customize the built-in HTTP transport used for requests and push sync | - |
...
| `FlagsPushUrl` | `Uri?` | Override the push-sync SSE endpoint (`GET /sse/server`) | - |
