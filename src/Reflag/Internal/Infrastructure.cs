...
internal sealed class HttpClientTransport : IReflagHttpTransport, IDisposable
{
    ...
    public async Task<ReflagHttpResponse<TResponse>> GetAsync<TResponse>(
        Uri url,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new ReflagHttpResponse<TResponse>
        {
    ...
    public async Task<ReflagHttpResponse<TResponse>> PostAsync<TRequest, TResponse>(
        Uri url,
        IReadOnlyDictionary<string, string> headers,
        TRequest body,
        CancellationToken cancellationToken = default)
